      ...
      <div className="flex-1 p-2 flex flex-col gap-1">
        ...
        <div className="flex-1 flex flex-row sm:flex-col">
          <div className="flex-1 flex flex-row gap-2 justify-center sm:justify-start items-center">
            ...
            <div className="hidden sm:line-clamp-6 flex-1 text-sm"><EffectDescription descriptions={pCard.produceDescriptions} /></div>
          </div>
          <div className="flex-1 flex flex-row gap-2 justify-center sm:justify-start items-center">
            <ProduceItemIcon withHoverDescription item={pItem} className="flex-none relative h-[68px] w-[68px]" />
            <div className="hidden sm:line-clamp-6 flex-1 text-sm"><EffectDescription descriptions={pItem.produceDescriptions} /></div>
          </div>
        </div>
