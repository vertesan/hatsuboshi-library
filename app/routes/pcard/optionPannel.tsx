...
export function OptionPannel({
  ...
  const onFilterChangeJump = <T extends keyof ProduceCardFilter>(key: T, val: ProduceCardFilter[T]) => {
  ...
  return (
    <div>
      ...
      <ChipGroup multiple isEnum value={filter.categories} onChange={(value) => onFilterChangeJump("categories", value)}>
      ...
      <ChipGroup multiple isEnum={false} value={filter.origin} onChange={(value) => onFilterChangeJump("origin", value as ('none' | 'cidol' | 'csprt')[])}>
      ...
      <ChipGroup multiple isEnum value={filter.grades} onChange={(value) => onFilterChangeJump("grades", value)}>
      ...
      <MultiSelectEnum
        ...
        onChange={(value) => onFilterChangeJump("effectTypes", value)}
      />
      ...
      <Switch
        ...
        onChange={(event) => onFilterChangeJump("requirePLevel", event.currentTarget.checked)}
      />
    </div>
  )
}
