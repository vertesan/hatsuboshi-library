const translation = {
  "meta-name": "初星资料库",
  "meta-description": "为初星学院制作系所有制作人提供的实用应用程序",
  ...
  "Your data is processed locally on your device.": "数据将在您的设备本地处理。",
  "Save checked": "保存",
  "Load checked": "加载",
  "Protection": "保护锁",
  "Protected": "已锁定",
  ...
  "Power": "体力",
  "Rank": "评级",
  "Scenario: HAJIME": "剧本：初",
  "Scenario: N.I.A": "剧本：N.I.A",
  "Treat welfare SSR as SR": "将福利 SSR 视为 SR",
  "Show Customization": "显示附魔",
  ...
  "We apologize for any inconvenience potentially caused.": "对于可能造成的不便，我们深表歉意。",
  ...
  "AuditionParameterBonusMultiple": "属性加成 (百分比)",
